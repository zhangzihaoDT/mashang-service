...
class QueryTool:
    def __init__(self, data_path_file: str, schema_dir: str):
        ...
        self._loaded = False
        self._dataset_mtimes: dict[str, float] = {}
    ...
    def _load_datasets(self) -> None:
        for file_path in self._parse_dataset_paths():
            ...
            if self._loaded and cache_key in self._dataset_mtimes and self._dataset_mtimes.get(cache_key) == mtime:
                continue
            ...
            self._dataset_mtimes[cache_key] = mtime
        self._loaded = True
