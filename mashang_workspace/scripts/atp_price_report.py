...
用法:
    python mashang_workspace/scripts/atp_price_report.py --month 2026-05
    python mashang_workspace/scripts/atp_price_report.py --month 2026-05 --format json
    python mashang_workspace/scripts/atp_price_report.py --month 2026-05 --format json --output outputs/tables/
    python mashang_workspace/scripts/atp_price_report.py --help
"""
...
def main():
    ...
    contract = build_success_contract(
        script="mashang_workspace/scripts/atp_price_report.py", command=cmd,
