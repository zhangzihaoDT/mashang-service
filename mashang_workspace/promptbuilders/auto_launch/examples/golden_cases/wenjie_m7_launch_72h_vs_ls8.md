...
| 角色 | 品牌 | 车型 | 说明 |
|------|------|------|------|
| **事件车型（event_model）** | 问界 | M7 | 本次发生上市/预售/发布会等事件的车型 |
| **本品车型（our_model）** | 智己 | LS8 | 我方被影响车型 |
| **竞争战场** | — | large_six_seat_suv | 同战场竞品背景 |

本报告的核心问题是：**event_model（问界 M7）本次事件，对 our_model（智己 LS8）造成什么影响？**
...
| 事件车型 | M7 |
| 事件类型 | 上市（launch） |
| 时间窗口 | 2026-07-08 至 2026-07-11 |
| 本品品牌 | 智己 |
| 本品车型 | LS8 |
| 关注竞品（战场背景） | 乐道 L80, 小鹏 GX, 岚图 泰山 X8 PHEV, 理想 i6, 零跑 D19 |
...
**目标**：判断 **event_model（问界 M7）** 本次事件对 **our_model（智己 LS8）** 的潜在影响，并结合 competitor_context 判断战场压力。
