...
| 角色 | 品牌 | 车型 | 说明 |
|------|------|------|------|
| **事件车型（event_model）** | 智己 | LS8 | 本次发生上市/预售/发布会等事件的车型 |
| **本品车型（our_model）** | （未指定） | （未指定） | 我方被影响车型 |
| **竞争战场** | — | large_six_seat_suv | 同战场竞品背景 |

本报告的核心问题是：**event_model（智己 LS8）本次事件，对 our_model（（未指定） （未指定））造成什么影响？**
...
| 跨战场补充数量 | 0 |
| 竞品来源 | watchlist |
| watchlist 文件路径 | mashang_workspace/configs/ls8_competitor_watchlist.csv |
| active 过滤 | 是 |
| group 同组优先 | 是 |
| 退化规则 | 无 |
...
|---|------|------|----------------|----------------|--------|
| 1 | 乐道 | 乐道 L80 | large_six_seat_suv | nio_ecosystem_suv | high |
| 2 | 小鹏 | 小鹏 GX | large_six_seat_suv | new_force_suv | high |
| 3 | 岚图 | 岚图 泰山 X8 PHEV | large_six_seat_suv | central_soe_suv | high |
| 4 | 理想 | 理想 i6 | large_six_seat_suv | new_force_suv | high |
| 5 | 问界 | 问界 M7 | large_six_seat_suv | huawei_ecosystem_suv | high |
...
| 本品品牌 | （未指定） |
| 本品车型 | （未指定） |
| 关注竞品（战场背景） | 乐道 L80, 小鹏 GX, 岚图 泰山 X8 PHEV, 理想 i6, 问界 M7 |
...
**目标**：分析 **智己 LS8** 本次事件的市场影响，收集价格、权益、配置、舆论、竞品对标等信息，评估其市场定位和竞争力。
