...
| 新车事件监测 | `python mashang_workspace/research_scripts/auto_launch_monitor.py --start 2026-06-05 --end 2026-06-07 --targets-file mashang_workspace/configs/ls8_competitor_watchlist.csv` | research |
